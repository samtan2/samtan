...
<main class="mx-auto max-w-[640px] px-6 py-16 space-y-3">
  ...
  <section id="s-garment" class="border border-zinc-200 rounded-xl px-5 py-4" style="margin-top: 1.5rem;">
    ...
    <div class="mb-4">
      <iframe srcdoc={garmentHtml} class="w-full rounded-xl border border-zinc-200 shadow-[0_8px_32px_rgba(0,0,0,0.20)]" style="height: 480px;" title="garment_gen demo"></iframe>
    </div>
  ...
  <section id="s-eigengrasp" class="border border-zinc-200 rounded-xl px-5 py-4">
    ...
    <h2 class="text-[16px] font-[520] text-zinc-900 mb-3">eigengrasp</h2>
    ...
    <iframe
      ...
      class="w-full rounded-xl border border-zinc-200 shadow-[0_8px_32px_rgba(0,0,0,0.20)]"
      style="height: 600px;"
  ...
  <section id="s-pill" class="border border-zinc-200 rounded-xl px-5 py-4">
    ...
    <h2 class="text-[16px] font-[520] text-zinc-900 mb-3">pill organizer</h2>
